...
def Draftview(request):
    ...
    return render(request, 'draftview.html', {'submissions': submissions})
...
def Submittedview(request):
    ...
    return render(request, 'submittedview.html', {'submissions': submissions})
